...
namespace _Project.Scripts.UI.Controllers.MainMenu
{
    ...
    public class BotUpgradeUIBehaviour : MonoBehaviour
    {
        ...
        private MainMenuBotUpgradePanelController _controller;
        private void Awake()
        {
            _bgImg = GetComponent<Image>();
            _upgradeButton.onClick.AddListener(UpgradeBtnClicked);
        }
        public void Initialize(PlayerMainMenuUpgradeInfo upgradeInfo, PlayerResource playerResource, MainMenuBotUpgradePanelController controller)
        {
        ...
        private void SetupView()
        {
            ...
            _upgradeButton.interactable = _playerResource.GemCount >= price;

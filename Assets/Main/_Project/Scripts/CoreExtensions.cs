...
public static class CoreExtensions
{
    ...
    public static List<T> FindComponentsInChild<T>(this Transform startGameObject)
    {
        ...
        SearchChildren(startGameObject, ref foundComponents);
        return foundComponents;
    }

    // Recursive yardımcı fonksiyon
    private static void SearchChildren<T>(Transform startTransform, ref List<T> foundComponents)
    {
        T component = startTransform.GetComponent<T>();
        if (component != null)
        {
        ...
        {
            SearchChildren(child, ref foundComponents);
        }
    }
    #region Int
    /// <summary>

...
namespace Pack.GameData
{
    ...
    public class GameDataEditor : EditorWindow
    {
        ...
        {
            dataPath = "Assets/Main/_Project/Scripts/Template/GameDataEditor/Scripts/GameData.asset";
        ...
        private void LoadUxmlAndUss()
        {
            ...
            // Import UXML
            var visualTree =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Main/_Project/Scripts/Template/GameDataEditor/Editor/GameDataEditor.uxml");

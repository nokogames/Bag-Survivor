...
{
    [CreateAssetMenu(fileName = "SwordSkill", menuName = "ScriptableObjects/SkillSystem/SwordSkill", order = 0)]
    public class SwordSkill : SkillBase
    {

        [SerializeField] private List<SwordSkillByRarity> _axeDataByRarity;
        private SwordSkillByRarity _skillRarityData;
        ...
        {
            var bullet = ParticlePool.SharedInstance.GetPooledObject(_skillRarityData.swordPrefab);
    ...
    [Serializable]
    public struct SwordSkillByRarity
    {
